...
for file in "$INPUT_DIR"/*.png; do
  ...
  magick "$file" -resize 300 -quality 85 "$filename-mobile.png"  # Version mobile en PNG
  magick "$file" -resize 300 -quality 85 "$filename-mobile.webp"  # Version mobile en WebP

  # Générer la version tablette (768px)
  magick "$file" -resize 768 -quality 85 "$filename-tablet.png"  # Version tablette en PNG
  magick "$file" -resize 768 -quality 85 "$filename-tablet.webp"  # Version tablette en WebP

  # Générer la version ordinateur (1200px)
  magick "$file" -resize 1200 -quality 85 "$filename-desktop.png"  # Version ordinateur en PNG
