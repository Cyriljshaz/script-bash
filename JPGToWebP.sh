...
for file in "$INPUT_DIR"/*.jpg; do
  ...
  magick convert "$file" -resize 300 -quality 85 "$filename-mobile.jpg"  # Version mobile en JPG
  magick convert "$file" -resize 300 -quality 85 "$filename-mobile.webp"  # Version mobile en WebP

  # Générer la version tablette (768px)
  magick convert "$file" -resize 768 -quality 85 "$filename-tablet.jpg"  # Version tablette en JPG
  ...
  magick convert "$file" -resize 1200 -quality 85 "$filename-desktop.jpg"  # Version ordinateur en JPG
