...
for file in "$INPUT_DIR"/*.jpg; do
  ...
  magick convert "$file" -resize 320 -quality 100 "$filename-placeholder-small.png"  # Petit en PNG

  # Placeholder moyen (640px)
  magick convert "$file" -resize 640 -quality 100 "$filename-placeholder-medium.png"  # Moyen en PNG

  # Placeholder large (1024px)
  magick convert "$file" -resize 1024 -quality 100 "$filename-placeholder-large.png"  # Large en PNG

  # Placeholder très grand (1920px)
  magick convert "$file" -resize 1920 -quality 100 "$filename-placeholder-xlarge.png"  # Très grand en PNG
